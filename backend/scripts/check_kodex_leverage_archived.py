"""
KODEX 레버리지 관련 ARCHIVED 데이터 검증 스크립트
- REPLACED인데 TTL을 초과한 경우 TTL_EXPIRED로 변경 필요
- TTL_EXPIRED인 경우 TTL 만료 시점의 수익률 사용 필요
"""
import sys
import os
...
def check_kodex_leverage_archived():
    """KODEX 레버리지 관련 ARCHIVED 데이터 검증"""
    try:
