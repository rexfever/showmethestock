      ...
      <div className="fixed bottom-0 left-0 right-0 bg-black text-white z-[9999]" style={{ pointerEvents: 'auto' }}>
        <div className="flex justify-around items-center py-2" style={{ pointerEvents: 'auto' }}>
          {menuItems.korean_stocks && (
            ...
            >
              <span className="text-2xl mb-1 h-5 flex items-center justify-center">🇰🇷</span>
              <span className="text-xs text-center leading-tight h-4">한국</span>
            </button>
          )}
          {menuItems.us_stocks && (
            <button 
            ...
            >
              <span className="text-2xl mb-1 h-5 flex items-center justify-center">🇺🇸</span>
              <span className="text-xs text-center leading-tight h-4">미국</span>
            </button>
          )}
          <button 
            type="button"
            ...
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
              const targetPath = '/archived';
              console.log('[BottomNav] 추천이력 버튼 클릭:', { currentPath: router?.asPath, targetPath });
              if (router?.asPath === targetPath) {
                console.log('[BottomNav] 같은 페이지이므로 이동하지 않음');
                return;
              }
          ...
          >
            ...
            <span className="text-xs text-center leading-tight h-4">추천이력</span>
          </button>
          {user?.is_admin && (
            <button 
              type="button"
            ...
            <span className="text-xs text-center leading-tight h-4">관리자</span>
            </button>
          )}
          <button 
            type="button"
          ...
          >
            ...
            <span className="text-xs text-center leading-tight h-4">설정</span>
          </button>
          {menuItems.more && (
            <button 
              type="button"
            ...
            <span className="text-xs text-center leading-tight h-4">더보기</span>
            </button>
          )}
        </div>
      </div>
