    ...
    try:
        ...
        with db_manager.get_cursor(commit=False) as cur:
            ...
            for row in rows:
                ...
                us_regime = row[3]
                preopen = row[4]
                kr_metrics_json = row[5]
                us_metrics_json = row[6]
                version = row[7]
                ...
                try:
                    if kr_metrics_json:
                        kr_metrics = json.loads(kr_metrics_json)
                ...
                try:
                    if us_metrics_json:
                        us_metrics = json.loads(us_metrics_json)
                        # us_prev_score 찾기
            ...
            agreement = 0
            for row in rows:
                if row[2] == row[3]:  # kr_sentiment == us_prev_sentiment
                    agreement += 1
